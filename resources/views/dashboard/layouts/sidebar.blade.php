    ...
    <div class="w-100">
            <div class="d-flex flex-between-center">
                    <button class="btn navbar-toggler-humburger-icon navbar-toggler me-1 me-sm-3"
                            ...
                            aria-controls="navbarDoubleTop" aria-expanded="false"
                                                    ...
                                                    <div class="scrollbar list py-3"
                                                            ...
                                                            <h6
                                                                    ...
                                                                    <div
                                                                            ...
                                                                            <span
                                                                                    class="fas fa-circle me-2 text-300 fs-11"></span>
                                                                            <div
                                                                    ...
                                                                    <div
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <img class="border h-100 w-100 object-fit-cover rounded-3"
                                                                                            src="dasbor/img/products/3-thumb.png"
                                                                                            alt="" />
                                                                            </div>
                                                                            <div
                                                                                    class="flex-1">
                                                            ...
                                                            <h6
                                                                    ...
                                                                    <div
                                                                            class="d-flex align-items-center">
                                                                            <div
                                                                                    class="avatar avatar-l status-online me-2">
                                                                                    <img class="rounded-circle"
                                                                                            src="dasbor/img/team/1.jpg"
                                                                                            alt="" />
                                                                            </div>
                                                                            <div
                                                                                    class="flex-1">
                                                            ...
                                                            <a class="dropdown-item px-x1 py-2"
                                                                    ...
                                                                    <div
                                                                            class="d-flex align-items-center">
                                                                            <div
                                                                                    class="avatar avatar-l me-2">
                                                                                    <img class="rounded-circle"
                                                                                            src="dasbor/img/team/2.jpg"
                                                                                            alt="" />
                                                                            </div>
                                                                            <div
                                                                                    class="flex-1">
                    ...
                    <ul
                            ...
                            <li class="nav-item d-none d-sm-block">
                                    <a class="nav-link px-0 notification-indicator notification-indicator-warning notification-indicator-fill fa-icon-wait"
                                            href="app/e-commerce/shopping-cart.html"><span
                                                                            ...
                                                                            <a class="notification notification-flush notification-unread"
                                                                                    ...
                                                                                    <div
                                                                                            ...
                                                                                            <div
                                                                                                    ...
                                                                                                    <img class="rounded-circle"
                                                                                                            src="dasbor/img/team/1-thumb.png"
                                                                                                            alt="" />
                                                                                            </div>
                                                                                    </div>
                                                                                    <div
                                                                            ...
                                                                            <a class="notification notification-flush"
                                                                                    ...
                                                                                    <div
                                                                                            ...
                                                                                            <div
                                                                                                    class="avatar avatar-2xl me-3">
                                                                                                    <img class="rounded-circle"
                                                                                                            src="dasbor/img/icons/weather-sm.jpg"
                                                                                                            alt="" />
                                                                                            </div>
                                                                                    </div>
                                                                                    <div
                                                                            ...
                                                                            <a class="border-bottom-0 notification-unread  notification notification-flush"
                                                                                    ...
                                                                                    <div
                                                                                            ...
                                                                                            <div
                                                                                                    ...
                                                                                                    <img class="rounded-circle"
                                                                                                            src="dasbor/img/logos/oxford.png"
                                                                                                            alt="" />
                                                                                            </div>
                                                                                    </div>
                                                                                    <div
                            ...
                            <li class="nav-item dropdown px-1">
                                    <a class="nav-link fa-icon-wait nine-dots p-1"
                                                                    ...
                                                                    <div
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/themewagon.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/mailbluster.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/google.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/spotify.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/steam.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/github-light.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/discord.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/xbox.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/trello.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/hp.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/linkedin.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/twitter.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/facebook.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/instagram.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/pinterest.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/slack.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                    class="rounded"
                                                                                                    src="dasbor/img/nav-icons/deviantart.png"
                                                                                                    alt=""
                                                                                                    width="40"
                                                                                                    height="40" />
                                                                                            <p
                            ...
                            <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2"
                                            ...
                                            <div class="avatar avatar-xl">
                                                    <img class="rounded-circle"
                                                            src="dasbor/img/team/3-thumb.png"
                                                            alt="" />
                                            </div>
                                    </a>
                                    <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                                            ...
                                            <div
                                                    ...
                                                    <a class="dropdown-item"
                                                            href="pages/user/profile.html">Profile
                                                            &amp; account</a>
                                                    <a class="dropdown-item"
                                                            href="#!">Feedback</a>
                                                    <div class="dropdown-divider"></div>
                    ...
                    <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
                                    ...
                                    <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0"
                                            ...
                                            <div
                                                    ...
                                                    <a class="dropdown-item link-600 fw-medium"
                                                            ...
                                                            class="dropdown-item link-600 fw-medium"
                                                            href="dashboard/support-desk.html">Support
                                                            desk<span
                            ...
                            <li class="nav-item dropdown"><a
                                    ...
                                    <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0"
                                            ...
                                            <div
                                                    ...
                                                    <div
                                                            class="card-body scrollbar max-h-dropdown">
                                                            <img class="img-dropdown"
                                                                    src="dasbor/img/icons/spot-illustrations/authentication-corner.png"
                                                                    width="130" alt="" />
                                                            <div class="row">
                                                                    <div
                            ...
                            <li class="nav-item dropdown"><a
                                    ...
                                    <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0"
                                            ...
                                            <div
                                                    class="card navbar-card-pages shadow-none dark__bg-1000">
                                                    <div
                                                            class="card-body scrollbar max-h-dropdown">
                                                            <img class="img-dropdown"
                                                                    src="dasbor/img/icons/spot-illustrations/authentication-corner.png"
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <p
                                                                                            ...
                                                                                            top<span
                                                                                                    class="badge rounded-pill ms-2 badge-subtle-success">New</span></a><a
                                                                                            class="nav-link py-1 link-600 fw-medium"
                                                                                            href="demo/combo-nav.html">Combo
                                                                                            nav</a>
                                                                                    <p
                                                                                            class="nav-link text-700 mb-0 fw-bold">
                                                                                            Others
                                                                    ...
                                                                    <div
                                                                            ...
                                                                            <div
                                                                                    ...
                                                                                    <p
                                                                                            ...
                                                                                            href="pages/faq/faq-basic.html">Faq
                                                                                            basic</a><a
                                                                                            class="nav-link py-1 link-600 fw-medium"
                                                                                            href="pages/faq/faq-alt.html">Faq
                                                                                            alt</a><a
                                                                                            class="nav-link py-1 link-600 fw-medium"
                                                                                            href="pages/faq/faq-accordion.html">Faq
                                                                                            accordion</a>
                                                                            </div>
                                                                    </div>
                                                                    <div
                                                    ...
                                                    <div
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div
                                                                            class="col-6 col-xxl-3">
                                                                            <div
                                                                                    class="nav flex-column mt-md-4 pt-md-1">
                                                                                    <a class="nav-link py-1 link-600 fw-medium"
                                                                    ...
                                                                    <div
                                                                            class="col-6 col-xxl-3">
                                                                            <div
                                                                                    class="nav flex-column mt-xxl-4 pt-xxl-1">
                                                                                    <a class="nav-link py-1 link-600 fw-medium"
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div
                                                                            class="col-6 col-xxl-3">
                                                                            <div
                                                                                    class="nav flex-column pt-xxl-1">
                                                                                    <p
                                                                                            class="nav-link text-700 mb-0 fw-bold">
                                                                                            Icons
                                                                                    </p><a class="nav-link py-1 link-600 fw-medium"
                    ...
                    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                    ...
                                    <div
                                            ...
                                            <div class="col ps-0">
                                                    <hr
                                                            class="mb-0 navbar-vertical-divider" />
                                            </div>
                                    </div><!-- parent pages--><a class="nav-link"
                                            href="app/calendar.html" role="button">
                                            <div class="d-flex align-items-center"><span
                                                            class="nav-link-icon"><span
                                                                    class="fas fa-calendar-alt"></span></span><span
                                                            class="nav-link-text ps-1">Calendar</span>
                                            </div>
                                    </a><!-- parent pages--><a class="nav-link"
                                            href="app/chat.html" role="button">
                                            <div class="d-flex align-items-center"><span
                                                            class="nav-link-icon"><span
                                    ...
                                    <ul class="nav collapse" id="email">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Email
                                                                            detail</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    ...
                                    <ul class="nav collapse" id="events">
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Create
                                                                            an event</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Event
                                                                            detail</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    ...
                                    <ul class="nav collapse" id="e-commerce">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Shopping
                                                                            cart</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    ...
                                    <ul class="nav collapse" id="e-learning">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Student
                                                                            overview</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Trainer
                                                                            profile</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    </ul><!-- parent pages--><a class="nav-link"
                                            href="app/kanban.html" role="button">
                                            <div class="d-flex align-items-center"><span
                                                            class="nav-link-icon"><span
                                    ...
                                    <ul class="nav collapse" id="social">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Activity
                                                                            log</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    ...
                                    <ul class="nav collapse" id="support-desk">
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Table
                                                                            view</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Contact
                                                                            details</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Tickets
                                                                            preview</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Quick
                                                                            links</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                            ...
                            <li class="nav-item">
                                    ...
                                    <div
                                            ...
                                            href="pages/starter.html" role="button">
                                            <div class="d-flex align-items-center"><span
                                                            class="nav-link-icon"><span
                                            ...
                                            href="pages/landing.html" role="button">
                                            <div class="d-flex align-items-center"><span
                                                            class="nav-link-icon"><span
                                            ...
                                            class="nav-link dropdown-indicator"
                                            href="#authentication" role="button"
                                            data-bs-toggle="collapse" aria-expanded="false"
                                    ...
                                    <ul class="nav collapse" id="authentication">
                                            ...
                                            class="nav-link dropdown-indicator" href="#user"
                                    ...
                                    <ul class="nav collapse" id="pricing">
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Pricing
                                                                            default</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            class="nav-link dropdown-indicator" href="#faq"
                                            role="button" data-bs-toggle="collapse"
                                    ...
                                    <ul class="nav collapse" id="errors">
                                            ...
                                            class="nav-link dropdown-indicator"
                                            href="#miscellaneous" role="button"
                                            data-bs-toggle="collapse" aria-expanded="false"
                                    ...
                                    <ul class="nav collapse" id="miscellaneous">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Invite
                                                                            people</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Privacy
                                                                            policy</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    ...
                                    <ul class="nav collapse" id="forms">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Floating
                                                                            labels</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    ...
                                    <ul class="nav collapse" id="tables">
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Basic
                                                                            tables</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    ...
                                    <ul class="nav collapse" id="icons">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Bootstrap
                                                                            icons</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Material
                                                                            icons</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    </ul><!-- parent pages--><a
                                            class="nav-link dropdown-indicator" href="#maps"
                                            role="button" data-bs-toggle="collapse"
                                    ...
                                    <ul class="nav collapse" id="maps">
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Google
                                                                            map</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Leaflet
                                                                            map</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    ...
                                    <ul class="nav collapse" id="components">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Animated
                                                                            icons</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Bottom
                                                                            bar</span><span
                                                                            class="badge rounded-pill ms-2 badge-subtle-success">New</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Cookie
                                                                            notice</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Progress
                                                                            bar</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Typed
                                                                            text</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    ...
                                    <ul class="nav collapse" id="utilities">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Colored
                                                                            links</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Focus
                                                                            ring</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Overlay
                                                                            scrollbar</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Stretched
                                                                            link</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Vertical
                                                                            align</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Visually
                                                                            hidden</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                                            </li>
                                    </ul><!-- parent pages--><a class="nav-link"
                                            href="widgets.html" role="button">
                                            <div class="d-flex align-items-center"><span
                                                            class="nav-link-icon"><span
                                    ...
                                    <ul class="nav collapse" id="multi-level">
                                            <li class="nav-item"><a
                                                            ...
                                                            <div
                                                                    class="d-flex align-items-center">
                                                                    <span
                                                                            class="nav-link-text ps-1">Level
                                                                            two</span>
                                                            </div>
                                                    </a><!-- more inner pages-->
                            ...
                            <li class="nav-item">
                                    ...
                                    <ul class="nav collapse" id="customization">
                                            ...
                                            href="documentation/faq.html" role="button">
                                            <div class="d-flex align-items-center"><span
                                                            class="nav-link-icon"><span
                                                                    class="fas fa-question-circle"></span></span><span
                                                            class="nav-link-text ps-1">Faq</span>
                                            ...
                                            href="documentation/gulp.html" role="button">
                                            <div class="d-flex align-items-center"><span
                                                            class="nav-link-icon"><span
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                            ...
                                                            class="nav-link-text ps-1">Design
                                                            file</span></div>
                                    </a><!-- parent pages--><a class="nav-link"
                                            href="changelog.html" role="button">
                                            <div class="d-flex align-items-center"><span
                                                            class="nav-link-icon"><span
                            ...
                            <div class="card shadow-none">
                                    <div class="card-body alert mb-0" role="alert">
                                            ...
                                            <div class="text-center"><img
                                                            src="dasbor/img/icons/spot-illustrations/navbar-vertical.png"
                                                            alt="" width="80" />
                                                    <p class="fs-11 mt-2">Loving what you
                                                            see? <br />Get your copy of <a
                                                                    href="#!"></a></p>
                                                    <div class="d-grid"><a
...
<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-lg"
                                ...
                                <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
                                        <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
                                                ...
                                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
                                                                href="#" role="button" data-bs-toggle="dropdown"
                                                                aria-haspopup="true" aria-expanded="false"
                                                                id="documentations">Documentationb</a>
                                                        <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0"
                                                                aria-labelledby="documentations">
                                                                <div class="bg-white dark__bg-1000 rounded-3 py-2"><a
                                                                                class="dropdown-item link-600 fw-medium"
                                ...
                                <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                                                        ...
                                                        <div class="card card-notification shadow-none">
                                                                <div class="card-header">
                                                                        <div
                                                                                ...
                                                                                <div class="col-auto ps-0 ps-sm-3"><a
                                                                ...
                                                                <div class="card-footer text-center border-top"><a
                                        ...
                                        <li class="nav-item dropdown px-1">
                                                <a class="nav-link fa-icon-wait nine-dots p-1" id="navbarDropdownMenu"
                                                        role="button"
                                                        data-hide-on-body-scroll="data-hide-on-body-scroll"
                                                        data-bs-toggle="dropdown" aria-haspopup="true"
                                        ...
                                        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2"
                                                        ...
                                                        <div class="avatar avatar-xl">
                                                                <img class="rounded-circle"
                                                                        src="dasbor/img/team/3-thumb.png" alt="" />
                                                        </div>
                                                </a>
                                                <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                                                        aria-labelledby="navbarDropdownUser">
