                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-6 mb-4">
                                                                ...
                                                                <div class="card shadow mb-4">
                                                                        ...
                                                                        $lainnya = Transaction::where('sub_kategori','Lainnya')->count();
                                                                        $lainnya = Transaction::where('sub_kategori','Lainnya')->sum('nominal');
                                                                        $bensin = Transaction::where('sub_kategori','Bensin')->count();
                                                                        $ubm = Transaction::where('sub_kategori','Uang Bulanan Mami')->count();
                                                                        $wifi = Transaction::where('sub_kategori','Wifi')->count();
                                                                        $jajan = Transaction::where('sub_kategori','Jajan')->count();
                                                                        $shopping = Transaction::where('sub_kategori','Online Shop')->count();
                                                                        $pulsa = Transaction::where('sub_kategori','Pulsa / Kuota')->count();
                                                                        $perpuluhan = Transaction::where('sub_kategori','Perpuluhan')->count();
                                                                        ...
                                                                        @endphp
                                                                                ...
                                                                                <div class="card-body">
                                                                                        ...
                                                                                        <div class="progress">
                                                                                                <div class="progress-bar bg-muted"
                                                                                                        role="progressbar"
                                                                                                        style="width: 100%"
                                                                                                        aria-valuenow="100"
                                                                                                        aria-valuemin="0"
