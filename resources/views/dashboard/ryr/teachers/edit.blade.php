...
<div class="col-lg-8">
    <form method="post" action="{{ route('teachers.update', $teacher->id) }}" class="mb-5"
        ...
        <div class="mb-3">
            ...
            <br>
            <img src="{{ asset('storage/' . $teacher->foto) }}" class="img-preview img-fluid mb-3 col-sm-5"
                alt="Teacher's photo">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('instagram') is-invalid @enderror" id="instagram"
                name="instagram" autofocus value="{{$teacher->instagram}}">
            @error('instagram')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
