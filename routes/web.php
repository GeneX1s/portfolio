...
use App\Http\Controllers\RYR\LanguageController;
...
Route::middleware('log-user-activity')->group(function () { //audit trail(LogUserActivity.php,Kernel.php)
    ...
    Route::get('/ryr/teacher', [TeacherController::class, 'profile'])->name('ryr.teacher');
...
//////////////RYR///////////////
//Classes
Route::get('/ryr/class', [ClassController::class, 'classPage'])->name('ryr.class');
